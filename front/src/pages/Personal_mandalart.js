    ...
    return (
      <>
        <Link to="/" className="link">
          <h3 className="title">MANDALPLAN</h3>
        </Link>
        <div className="out">
          {/* <h3>
          ...
          <hr />
          <br />
          <div className="mandal_comment">
            <div className="comment_image">
              <img className="profile" src={img} alt="profile_img"></img>
            </div>
            <div className="commnent_inside">
              <br />
              <strong>NAME</strong> : {value.name}
              <br />
              <br />
              <br />
              <strong>GOAL</strong> : {value.goal}
              <br /> <br /> <br />
